import { ExternalLink, Loader2, Phone, UserRound, Wallet } from 'lucide-react'
...
import { ServiceJourneyTimeline } from './ServiceJourneyTimeline'
            ...
            <>
              ...
              <div className="mt-5 rounded-xl border border-slate-200 bg-gradient-to-br from-slate-50 to-white p-4">
                <div className="mb-3 flex items-center gap-2">
                  <span className="flex h-7 w-7 items-center justify-center rounded-md bg-white text-emerald-600 ring-1 ring-emerald-100">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-xs text-slate-500">
                      Các mốc thời gian ghi nhận được trong booking này.
                    </p>
                  </div>
                </div>
                <ServiceJourneyTimeline
                  serviceStartedAt={
                    (detail?.service_started_at as string | null | undefined) ??
                    null
                  }
                  serviceCompletedAt={display.serviceCompletedAt ?? null}
                  paidAt={(detail?.paid_at as string | null | undefined) ?? display.washedAt}
                />
              </div>
            </>
          ) : (
